...
const FaqView: React.FC<FaqViewProps> = ({ t, getThemeClasses, setCurrentView }) => {
  ...
  const faqData = [
    ...
    { q: 'Kan ik mijn account op meerdere apparaten gebruiken?', a: 'Ja! Schoolmaps is een web-app, wat betekent dat je kunt inloggen vanaf elke computer, tablet of telefoon met een internetbrowser. Al je gegevens worden automatisch gesynchroniseerd.'},
